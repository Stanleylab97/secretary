 ...
 */
final class Version20210106235740 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE agent (id INT AUTO_INCREMENT NOT NULL, direction_id INT DEFAULT NULL, service_id INT DEFAULT NULL, mission_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, matricule VARCHAR(255) NOT NULL, sexe VARCHAR(255) NOT NULL, fonction VARCHAR(255) NOT NULL, contact VARCHAR(255) NOT NULL, INDEX IDX_268B9C9DAF73D997 (direction_id), INDEX IDX_268B9C9DED5CA9E6 (service_id), INDEX IDX_268B9C9DBE6CAE90 (mission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE chauffeur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, contacts VARCHAR(255) NOT NULL, permis VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
